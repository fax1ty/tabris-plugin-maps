...
abstract class LatLngInterpolator {
    abstract fun interpolate(fraction: Float, a: LatLng, b: LatLng): LatLng?
    ...
    class Spherical : LatLngInterpolator() {
        ...
        private fun computeAngleBetween(fromLat: Double, fromLng: Double, toLat: Double, toLng: Double): Double { // Haversine's formula
            val dLat = fromLat - toLat
            val dLng = fromLng - toLng
            return 2 * asin(sqrt(sin(dLat / 2).pow(2.0) +
